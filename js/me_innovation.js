...
demo.controller("ctrl",  ['$scope', function($scope){
	...
	// These three functions help to display correct stats under each category for mobile
	...
	$scope.items = [
		...
		{title: "Basketball Quiz", tech: "HTML5, CSS3, JavaScript, Angular, jQuery, Responsive", desc: "Simple quiz app.", link: "http://mse2321.github.io/basketball-quiz/", link2: "https://github.com/mse2321/basketball-quiz", image: "build/img/sample-image3-min.jpg"}
	];
